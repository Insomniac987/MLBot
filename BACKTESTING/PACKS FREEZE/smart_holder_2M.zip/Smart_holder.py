...
class TradingEnv(gym.Env):
    ...
    def step(self, action):
        ...
        f_pft = factores.get("pft", 1.0)
        f_pnl = factores.get("pnl", 100.0)
        f_hold_in = factores.get("hold_in", 0.001)
        f_hold_out = factores.get("hold_out", 0.01)
        f_noop = factores.get("noop", 1.0)
